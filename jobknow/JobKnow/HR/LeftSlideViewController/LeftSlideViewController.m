...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(noticeOpenLeftSide) name:@"OpenLeftSide" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(noticeCloseLeftSide) name:@"CloseLeftSide" object:nil];
}
...
#pragma mark - 接收通知来打开和关闭左视图

-(void)noticeOpenLeftSide{
...
- (void)openLeftView;
{
    ...
    [self.leftTableview reloadData];//打开左视图的时候，刷新一下数据

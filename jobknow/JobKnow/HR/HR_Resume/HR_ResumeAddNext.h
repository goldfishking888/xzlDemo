...
@interface HR_ResumeAddNext : BaseViewController<UIScrollViewDelegate,UIActionSheetDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate,SendRequest,TipViewDelegate,AVAudioPlayerDelegate,UIDocumentInteractionControllerDelegate,UITableViewDelegate,UITableViewDataSource,miaosuDeleat,changeHead,HR_ResumeImageAttachDelegate,HR_ResumeVoiceAttachDelegate,qzyxDeleat,jbxxwsDeleat,HR_ResumeEditDelegate,HR_ResumeTextDelegate>
{
    UIImageView *btniv;

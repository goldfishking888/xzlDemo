//
//  HRQuestionFeedbackViewController.m
//  JobKnow
//
...
@interface HRQuestionFeedbackViewController ()

@end

@implementation HRQuestionFeedbackViewController
int num;
...
- (void)viewDidLoad
{
    ...
    scrollView = [ [UIScrollView alloc ] initWithFrame:CGRectMake(0, 44, iPhone_width, iPhone_height) ];
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(20, -20, iPhone_width-20*2, 140)];
    label.backgroundColor = [UIColor clearColor];
    label.textColor = [UIColor darkGrayColor];
    label.text = @"HR圈致力于提供人力资源最佳解决产品，欢迎您提出宝贵建议，我们将不断完善。";
    label.font = [UIFont fontWithName:Zhiti size:15];
    label.numberOfLines = 4;
    [scrollView addSubview:label];
    
    //添加文本框下面的图片
    tableViewImage = [[UIImageView alloc] initWithFrame:CGRectMake(20, 90, iPhone_width-20*2, 44*3+14)];
    tableViewImage.image = [UIImage imageNamed:@"textView_2.png"];
    [scrollView addSubview:tableViewImage];
    //添加文本框
    self.textView = [[UITextView alloc]initWithFrame:CGRectMake(20, 90, iPhone_width-20*2, 44*3+14)];
    ...
    UILabel *label_info = [[UILabel alloc]initWithFrame:CGRectMake(20, 250, iPhone_width-20*2, 20)];
    ...
    UILabel *label1 = [[UILabel alloc]initWithFrame:CGRectMake(20, 270, iPhone_width-20*2, 20)];
    ...
    tableViewImage1 = [[UIImageView alloc]initWithFrame:CGRectMake(20, 305-20-9, iPhone_width-20*2, 44)];
    tableViewImage1.image = [UIImage imageNamed:@"mimaimg.png"];
    [scrollView addSubview:tableViewImage1];
    tableViewImage2 = [[UIImageView alloc] initWithFrame:CGRectMake(20, 350-20-4, iPhone_width-20*2, 44)];
    tableViewImage2.image = [UIImage imageNamed:@"mimaimg.png"];
    [scrollView addSubview:tableViewImage2];
    
    self.textField = [[UITextField alloc]initWithFrame:CGRectMake(30, 305-20-5, iPhone_width-30*2, 35)];
    ...
    self.textField2 = [[UITextField alloc]initWithFrame:CGRectMake(30, 305+45-20, iPhone_width-30*2, 35)];
    ...
    readBtn.frame=CGRectMake(20,380,iPhone_width-20*2,40);
    ...
    button.frame = CGRectMake(20, 410, iPhone_width-20*2, 40) ;
...
- (BOOL)textViewShouldBeginEditing:(UITextView *)textView
{
    ...
    [self viewAnimation:self.view frame:CGRectMake(0, -40, iPhone_width, iPhone_height) time:0.3];
...
//    net.delegate = self;
    ...
    NSMutableDictionary *paramDic = [NSMutableDictionary dictionaryWithObjects:[NSArray arrayWithObjects:IMEI,self.textView.text,@"IOS",nil] forKeys:[NSArray arrayWithObjects:@"userImei",@"contents",@"from", nil]];

...
#define PYSEARCH_SEARCH_HISTORY_CACHE_PATH [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:[NSString stringWithFormat:@"_%@_PYSearchhistories.plist",[mUserDefaults valueForKey:@"mobile"]]] // the path of search record cached

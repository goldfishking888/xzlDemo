...
- (void)awakeFromNib {
    ...
    _itemTitleSelectedColor = RGB(255, 178, 66);
...
- (void)setFrame:(CGRect)frame {
    ...
    UIView *view_line = [[UIView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, 0.5)];
    view_line.backgroundColor = RGB(178, 178, 178);

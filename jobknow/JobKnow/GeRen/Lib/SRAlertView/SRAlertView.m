...
#define kTitleFont     [UIFont systemFontOfSize:SCREEN_ADJUST(18)];
...
#define kTitleLabelColor                RGB(74, 74, 74)
...
#define kBtnHighlightedBackgroundColor  RGB(192, 192, 192)

#define kLineBackgroundColor  RGB(216, 216, 216)
...
- (void)setupActions {
    ...
    if (_rightActionTitle) {
        [_alertView addSubview:({
            ...
            [_rightAction setTitleColor:[UIColor orangeColor] forState:UIControlStateNormal];

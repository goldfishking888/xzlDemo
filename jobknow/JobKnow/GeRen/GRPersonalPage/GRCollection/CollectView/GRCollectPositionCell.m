...
#import "GRCollectPositionCell.h"
#define cellHeight 110
@interface GRCollectPositionCell(){
...
@implementation GRCollectPositionCell
...
-(void)setDataWithModel:(GRCollectPositionModel *)model{
    view_line.hidden = NO;
    salaryLab.hidden = NO;
    ...
    collectTimeLab.text = [NSString stringWithFormat:@"收藏于:%@",model.favorite_date];
    NSString * statusStr = @"";

...
@implementation CompanyIntroduce

@synthesize myTableView=_myTableView;
@synthesize delegate=_delegate;

-(id)initWithFrame:(CGRect)frame  withModel:(PositionModel *)info
{
    ...
    if (self) {
        ...
        //职位名称
        _companyName = [[CustomLabel alloc]labelinitWithText2:_positionModel.companyName X:5 Y:2];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0) {
        ...
        if (indexPath.row==0) {
            ...
            //公司性质
            UILabel*companyNatureLab = [[UILabel alloc] initWithFrame:CGRectMake(5,10,50,30)];
            ...
            if (_isDownLoad){
                ...
                _companyNature=[[CustomLabel alloc]labelinitWithText:text X:40 Y:10];
        ...
        }else if (indexPath.row==1)
        {
            ...
            //行业
            UILabel*companyIndustryLab = [[UILabel alloc] initWithFrame:CGRectMake(5,10,iPhone_width-165,30)];
            ...
            if (_isDownLoad){
                ...
                _companyIndustry=[[CustomLabel alloc]labelinitWithText:text X:40 Y:10];
        ...
        }else if (indexPath.row==2)
        {
            ...
            //行业
            UILabel*companySizeLab = [[UILabel alloc] initWithFrame:CGRectMake(5,10,60,30)];
            companySizeLab.font =[UIFont  systemFontOfSize:13];
            companySizeLab.backgroundColor = [UIColor clearColor];
            companySizeLab.text =@"企业规模:";
            [cell.contentView addSubview:companySizeLab];
            
            if (_isDownLoad){
                NSString *text=[_companyDic valueForKey:@"companySize"];
                if ([text length]>20) {
                    text=[text substringToIndex:19];
                    text=[text stringByAppendingString:@"···"];
                }
                ...
                _companySize=[[CustomLabel alloc]labelinitWithText:text X:63 Y:10];
                _companySize.backgroundColor=[UIColor clearColor];
                [cell.contentView addSubview:_companySize];
            }
            
        }else if (indexPath.row==3)
        {
            //企业详情
            UILabel*companyDetailLab = [[UILabel alloc] initWithFrame:CGRectMake(5,10, iPhone_width - 165,30)];
            ...
            if (_isDownLoad) {
                ...
                _companyIntroduce=[[CustomLabel alloc]labelinitWithText:text X:10 Y:5];
...
//            }else
                if ([str isEqualToString:@"网址"])
            {
                ...
                CustomButton *customBtn3 = [CustomButton customButtonInitWithButtonType:UIButtonTypeCustom frame:CGRectMake(60, 10, iPhone_width - 60, 30) title:strUrl fontNum:13];
                customBtn3.tag = 13;
            ...
            }else if ([str isEqualToString:@"地址"])
            {
                ...
                CustomButton *customBtn2 = [CustomButton customButtonInitWithButtonType:UIButtonTypeCustom frame:CGRectMake(58, 10,iPhone_width - 58,30) title:_positionModel.companyAddress fontNum:13];

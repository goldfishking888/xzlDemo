...
{    
    ...
    _outerCircleRect = CGRectMake(x+13, y, radius, radius);
    ...
    _innerCircleRect = CGRectMake(x+offset+13, y+offset, radius-2*offset , radius-2*offset);

...
@property (nonatomic, assign) id<UIMenuBarDelegate> Menudelegate;     // weak reference. default is nil
@property (nonatomic, copy)   NSMutableArray       *items;
@property (nonatomic, strong) UIMenuBarItem        *selectedItem; // will show feedback based on mode. default is nil

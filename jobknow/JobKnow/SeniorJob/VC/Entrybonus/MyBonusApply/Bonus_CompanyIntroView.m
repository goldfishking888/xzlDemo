...
#import "Bonus_CompanyIntroView.h"
...
@implementation Bonus_CompanyIntroView

@synthesize myTableView=_myTableView;
@synthesize delegate=_delegate;

-(id)initWithFrame:(CGRect)frame  withModel:(SeniorJobDetailModel *)info
{
    ...
    if (self) {
        ...
        //职位名称
        _companyName = [[CustomLabel alloc]labelinitWithText2:_positionModel.cname X:cell_inner_space Y:2];
    ...
    if (indexPath.section==0) {
        ...
        if (indexPath.row==0) {
            ...
            if (_isDownLoad){
                ...
                NSString *text=_positionModel.corpprop;
        ...
        }else if (indexPath.row==1)
        {
            ...
            if (_isDownLoad){
                NSString *text=_positionModel.trade;
                if ([text length]>20) {
        ...
        }else if (indexPath.row==2)
        {
            ...
            if (_isDownLoad) {
                ...
                NSString *text=_positionModel.intro;
    ...
    }else
    {
        ...
        }else
        {
            ...
            }else if ([str isEqualToString:@"地址"])
            {
                ...
                CustomButton *customBtn2 = [CustomButton customButtonInitWithButtonType:UIButtonTypeCustom frame:CGRectMake(cell_title_content_space, 10,iPhone_width - cell_title_content_space - 30,30) title:_positionModel.addr fontNum:13];
...
- (void)baiduClick:(id)sender
{
    ...
    [_delegate baidu:_positionModel.cname andTag:@"百度"];

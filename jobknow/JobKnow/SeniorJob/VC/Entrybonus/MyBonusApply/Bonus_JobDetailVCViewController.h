//
//  Bonus_JobDetailVCViewController.h
//  JobKnow
//
...
@protocol Bonus_JobDetailVCDelegate<NSObject>
@optional
-(void)jobReaderDetailVC;
@end

@interface Bonus_JobDetailVCViewController : BaseViewController <SendRequest,OtherJobDelegate,Bonus_JobDetailViewDelegate,UIMenuBarDelegate,UIScrollViewDelegate,SinaWeiboDelegate,SinaWeiboRequestDelegate,UIActionSheetDelegate,MFMessageComposeViewControllerDelegate>
{
    //    enum WXScene _scene;
...
//    UIButton *otherBtn;
    ...
    Bonus_JobDetailView *detailView;
    Bonus_CompanyIntroView *introduceView;

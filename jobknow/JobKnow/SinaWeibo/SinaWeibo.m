...
//                       params:[NSMutableDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"秒杀全部求职工具的手机求职神器“小职了”！强烈推荐使用：聚合城市全部职位、职位全部去重只显示新增、订阅后自动送达。前所未有的职场必备神器，马上安装，神奇感受全城机会来敲门！http://t.cn/zYymglE"], @"status", nil]
//                   httpMethod:@"POST"
//                     delegate:self];
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"weibo" object:nil];

    UIAlertView *al = [[UIAlertView alloc] initWithTitle:@"授权成功，请点击分享!" message:nil delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"分享",nil];
   [al show];
}

...
@interface SinaWeibo : NSObject <SinaWeiboAuthorizeViewDelegate, SinaWeiboRequestDelegate,UIAlertViewDelegate>
{
    NSString *userID;
...
@property (nonatomic, assign) id<sharWeibo> myDeleate;

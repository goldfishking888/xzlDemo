...
@interface Yuyin_fjViewController ()
{
    BOOL isAdd;
    MBProgressHUD *hud;
}
...
@implementation Yuyin_fjViewController
...
- (void)rightBtnAndRightClick
{
    ...
    [net sendToServerWithSound:_fileName soundName:name min:time resume:YES];
    [uploadView dismiss];
}
